...
//     this.gameCtx.fillText("Paused", this.gameCanvas.width / 3, this.gameCanvas.height / 2);
//     this.gameCtx.fillText("Press P to resume again", this.gameCanvas.width / 3, this.gameCanvas.height / 1.5);
//   }
...
//     this.gameCtx.font = "bold 24px 'Press Start 2P'";
//     this.gameCtx.fillText(this.dave.utilityMessage, 300, this.gameCanvas.height - 20);
//   }
...
//     this.gameCtx.clearRect(0, 0, canvasHeight, canvasWidth);
...
class Game {
  ...
  private displayGameOverRectangle() {
    ...
    button.style.top = `${rectY + rectHeight + 30}px`;
    button.style.left = `${rectX + rectWidth / 2 - 65}px`;
  ...
  private showLevelComplete() {
    if (this.dave.reachedEndMap) {
      ...
      this.isLevelComplete = true;
      this.initializeTiles(this.map);
      console.log("character position", this.setCharacterPosition());
      this.dave.isDoor = false;
